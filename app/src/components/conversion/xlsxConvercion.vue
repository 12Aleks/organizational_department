      ...
      try {
        ...
        await  Object.keys(res).map((key) => {
          list.push({
            ...
            salary: res[key]['__EMPTY_4'] === undefined ? 'data not found' : res[key]['__EMPTY_4'] !== 0? parseFloat(res[key]['__EMPTY_4'].toFixed(1)): 0,
            per_hour: res[key]['__EMPTY_5'] === undefined ? 'data not found' : res[key]['__EMPTY_5']!== 0? parseFloat(res[key]['__EMPTY_5'].toFixed(1)): 0,
            salary_worker: res[key]['__EMPTY_6'] === undefined ? 'data not found' : res[key]['__EMPTY_6']!== 0? parseFloat(res[key]['__EMPTY_6'].toFixed(1)): 0,
            per_hour_worker: res[key]['__EMPTY_7'] === undefined ? 'data not found' : res[key]['__EMPTY_7']!== 0? parseFloat(res[key]['__EMPTY_7'].toFixed(1)): 0,
            salary_department: res[key]['__EMPTY_8'] === undefined ? 'data not found' : res[key]['__EMPTY_8']!== 0? parseFloat(res[key]['__EMPTY_8'].toFixed(1)): 0,
            per_hour_department: res[key]['__EMPTY_9'] === undefined ? 'data not found' : res[key]['__EMPTY_9']!== 0? parseFloat(res[key]['__EMPTY_9'].toFixed(1)): 0,
            salary_HR: res[key]['__EMPTY_10'] === undefined ? 'data not found' : res[key]['__EMPTY_10']!== 0? parseFloat(res[key]['__EMPTY_10'].toFixed(1)): 0,
            per_hour_HR: res[key]['__EMPTY_11'] === undefined ? 'data not found' : res[key]['__EMPTY_11']!== 0? parseFloat(res[key]['__EMPTY_11'].toFixed(1)): 0,
            final_salary: res[key]['__EMPTY_12'] === undefined ? 'data not found' : res[key]['__EMPTY_12']!== 0? parseFloat(res[key]['__EMPTY_12'].toFixed(1)): 0,
            final_per_hour: res[key]['__EMPTY_13'] === undefined ? 'data not found' : res[key]['__EMPTY_13']!== 0? parseFloat(res[key]['__EMPTY_13'].toFixed(1)): 0,
